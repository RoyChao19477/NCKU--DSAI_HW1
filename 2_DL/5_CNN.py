    ...
    for i in range(50):
        ...
        if min_loss > test_loss:
            torch.save({ 
                ...
                'optimizer_state_dict': optimizer.state_dict()}, 'src/results/10_CNN_01_epoch50_7days.pt')
            np.savetxt("src/results/10_CNN_01_pred_epoch50_7days.csv", np.asarray( pred_list ), delimiter=',')
