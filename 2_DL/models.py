...
class LSTM_02(nn.Module):
    def __init__(self, ):
        super(LSTM_02, self).__init__()
...
class LSTM_03(nn.Module):
    def __init__(self, ):
        super(LSTM_03, self).__init__()
...
class LSTM_04(nn.Module):
    def __init__(self, ):
        super(LSTM_04, self).__init__()
...
class LSTM_06(nn.Module):
    def __init__(self, input_size):
        super(LSTM_06, self).__init__()
        self.input_size = input_size


        self.conv1 = nn.Conv1d(1, 1, 2, dilation=1)
        self.relu1 = nn.ReLU()
        self.conv2 = nn.Conv1d(1, 1, 2, dilation=2)
        self.relu2 = nn.ReLU()
        self.conv3 = nn.Conv1d(1, 1, 2, dilation=4)
...
class LSTM_07(nn.Module):
    def __init__(self, input_size):
        super(LSTM_07, self).__init__()
        self.input_size = input_size
